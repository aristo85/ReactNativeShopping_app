  ...
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        "https://m-complete-guide-d7b2c.firebaseio.com/products.json" //Get request by name (/products)
      );
...
export const onOrder = (orderedData) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        `https://m-complete-guide-d7b2c.firebaseio.com/orders/${userId}.json?auth=${token}`,
        {
          method: "POST",
          headers: {
...
export const deleteProduct = (productId) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        `https://m-complete-guide-d7b2c.firebaseio.com/products/${productId}.json?auth=${token}`,
        {
          method: "DELETE",
        }
      );
...
export const onEditSave = (dataInputs) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        `https://m-complete-guide-d7b2c.firebaseio.com/products/${dataInputs.id}.json?auth=${token}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
...
export const onCreateSave = (dataInputs) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        `https://m-complete-guide-d7b2c.firebaseio.com/products.json?auth=${token}`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export const getOrderedList = () => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch(
        `https://m-complete-guide-d7b2c.firebaseio.com/orders/${userId}.json`
      );
      const data = await response.json(); //from json to object
      const loadedOrders = [];
      if (!response.ok) {
